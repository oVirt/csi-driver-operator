...
import (
	...
	"github.com/ovirt/csi-driver-operator/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CsiV1alpha1Interface interface {
	RESTClient() rest.Interface
	OvirtCSIDriversGetter
}
...
func (c *CsiV1alpha1Client) OvirtCSIDrivers() OvirtCSIDriverInterface {
	return newOvirtCSIDrivers(c)
}

...
import "github.com/ovirt/csi-driver-operator/pkg/apis/operator/v1alpha1"
...
type Config struct {
	...
	DefaultImages v1alpha1.CSIDeploymentContainerImages `yaml:"defaultImages,omitempty"`
